...
class node_edge_feature_fusion(nn.Module):
    def __init__(self, args):
        super(node_edge_feature_fusion, self).__init__()
...
class GraphSNN_GAT_Layer(nn.Module):
    def __init__(self, args, snn_args, input_dim, output_dim):
        super(GraphSNN_GAT_Layer, self).__init__()
...
class GraphSNN_GAT(nn.Module):
    def __init__(self, args, snn_args):
        ...
        self.Fusion_atom_and_bond = node_edge_feature_fusion(args)
